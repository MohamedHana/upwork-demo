...
Sub EXPORT_INCOME_NOTE_REPORT()
    Call Utils.ExportReport(ThisWorkbook.Sheets("INCOME NOTE REPORT"))
End Sub


Sub REGENERATE_INCOME_NOTE_REPORT()
    Application.ScreenUpdating = False ' Turn off screen updating
    Application.Calculation = xlCalculationManual ' Turn off automatic calculation

    Dim reportName As String
    reportName = "INCOME NOTE REPORT"
